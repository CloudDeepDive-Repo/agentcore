...
# Check for old config and delete if exists
...
**Solution:** Video 3 shows how to move tools to AgentCore Gateway!
...
Ready to level up? Check out **Video 3** to learn how to move tools to AgentCore Gateway for better reusability and production-ready architecture!
